...
PendingAction _pendingActionDeserialize(
  ...
  object.transactionId = reader.readStringOrNull(offsets[5]);
...
extension PendingActionQuerySortBy
  ...
  QueryBuilder<PendingAction, PendingAction, QAfterSortBy> sortByCapturedAt() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PendingAction, PendingAction, QAfterSortBy> sortByLastError() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PendingAction, PendingAction, QAfterSortBy> sortByStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'status', Sort.asc);
    });
  }

  QueryBuilder<PendingAction, PendingAction, QAfterSortBy> sortByStatusDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PendingActionQuerySortThenBy
  ...
  QueryBuilder<PendingAction, PendingAction, QAfterSortBy> thenByCapturedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'capturedAt', Sort.asc);
    });
  }
  ...
  QueryBuilder<PendingAction, PendingAction, QAfterSortBy> thenByLastError() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastError', Sort.asc);
    });
  }
  ...
  QueryBuilder<PendingAction, PendingAction, QAfterSortBy> thenByStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'status', Sort.asc);
    });
  }

  QueryBuilder<PendingAction, PendingAction, QAfterSortBy> thenByStatusDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'status', Sort.desc);
    });
  }
...
extension PendingActionQueryWhereDistinct
  ...
  QueryBuilder<PendingAction, PendingAction, QDistinct> distinctByCapturedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension PendingActionQueryProperty
  ...
  QueryBuilder<PendingAction, DateTime, QQueryOperations> capturedAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'capturedAt');
    });
  }

  QueryBuilder<PendingAction, String?, QQueryOperations> lastErrorProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PendingAction, String, QQueryOperations> statusProperty() {
    return QueryBuilder.apply(this, (query) {
